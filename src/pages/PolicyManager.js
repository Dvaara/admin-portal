...
import PostEditor from '../components/PolicyEditor';
...
class PolicyManager extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <Typography variant="display1">Policy Manager</Typography>
                {this.state.posts.length > 0 ? (
                    ...
                    !this.state.loading && <Typography variant="subheading">No policies to display</Typography>
                )}
                <Button
                    variant="fab"
                    color="secondary"
